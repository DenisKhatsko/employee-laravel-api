...
namespace Illuminate\Support\Facades {
     ...
     */        class Response {
        ...
        {
                        return \Illuminate\Routing\ResponseFactory::success($data, $code);
        }
                    /**
         * 
         *
         ...
         * @param mixed $code
         * @static 
         */        public static function not_found($code = 404)
        {
                        return \Illuminate\Routing\ResponseFactory::not_found($code);
        }
            }
            /**
     * 
